...
public class SindhiPoetryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_sindhi_poetry, container, false);
        ...
        Query urduQuery = mDatabaseRef.orderByChild("type").equalTo("Sindhi");
    ...
    private void init(View root) {
        ...
        recyclerView=root.findViewById(R.id.rv_images_sindhi);
